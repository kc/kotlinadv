...
// 1. How can we implement a DSL for DML (i.e. select ...)?
// SELECT cu.name
//   FROM Country as co
...
//      - the lambda should have a receiver of type SqlExpressionBuilder (new class).
...
// 2. (IF TIME PERMITS) Extend your DSL to support and in a select, e.g.:
// (Country join Customer)
